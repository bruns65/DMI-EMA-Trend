...
st.markdown("""
    ...
    .sell-text { color: #ff5252; font-weight: bold; }aimport streamlit as st
import pandas as pd
import numpy as np
import requests
import time
...
if data_1h and data_15m and data_5m:
    ...
    # Extraction des conditions pour chaque UT
    ...
    # --- SÉCURITÉ : ALIGNEMENT TRIPLE ÉCRAN STRICT ---
...
if st.button("🔄 Actualiser les structures"):
    st.rerun()    .title-text { font-size: 18px; font-weight: bold; }
    </style>
""", unsafe_allow_html=True)
